...
from cvae_atari import DenseLatentPongNoBatchNorm
import sampling
import utils
import numpy as np


experiment = 'experiment_dense_latent_space_invaders_different_betas'
...
def train_dense_latent_pong_no_batchnorm(beta):
    ...
    # define filename
    name = 'cvae_atari_dense_latent_space_invaders_no_batchnorm_beta_' + str(beta)
...
if __name__ == '__main__':
    ...
    '''
    Train with no batch normalization with different betas
    '''
    # for beta in range(5):
    #     train_dense_latent_pong_no_batchnorm(beta)

    train_dense_latent_space_invaders_no_batchnorm(1)
