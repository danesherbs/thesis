...
with tf.device('/gpu:0'):
    ...
    print("\nSteps per epoch =", int(1000), sep=' ')
    print("Validation steps =", int(20), '\n', sep=' ')

    # fit model using generators and record in TensorBoard
    cvae.fit_generator(zip(train_generator, train_generator),
    				   validation_data=zip(test_generator, test_generator),
    				   validation_steps=20,
