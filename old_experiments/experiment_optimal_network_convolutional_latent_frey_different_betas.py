...
experiment = 'experiment_optimal_network_convolutional_latent_frey_different_betas'


def train_reconstruction_only_frey_network_with_image_latent_space(beta):
    # inputs
    input_shape = (1, 28, 20)
    filters = 32
    latent_filters = 1
...
if __name__ == '__main__':
    for beta in range(1, 9):
        train_reconstruction_only_frey_network_with_image_latent_space(beta)
    # main()