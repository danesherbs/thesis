...
\end{align}
We will also assume that the posterior is a $k$-dimensional Gaussian with diagonal covariance
\begin{align}
...
\end{align}
Luckily maximising terms like this is encountered regularly in statistics, and is known as maximum likelihood estimation. This can be taken to be the reconstruction loss as we defined it in the non-variational autoencoders earlier.

\subsubsection{Implementing the Variational Autoencoder}

In summary, to solve the original problems specified in the introduction, we 
