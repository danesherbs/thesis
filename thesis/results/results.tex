...
\item The latent image method also seemed to struggle to produce meaningful generative samples from the prior and posterior despite reasonable values irrespective of the value of the KL loss term.
\end{itemize}
