...
Formally, we'll define $f:\mathcal{Z}\times\Theta\rightarrow\mathcal{X}$ to be $f(\vec{z},\vec{\theta})$, where $\vec{\theta}$ stores the weights of the network to be trained via backpropagation. 
